    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
              <div class="col-md-12">
                <a href="<?php echo site_url("masterstudent/list_master_student"); ?>" class="btn btn-primary pull-right">Daftar</a>
                </div>
                <div class="col-md-12">
                    <div class="box">
                                ...
                                <div class="form-group">
                                   ...
                                   <!-- <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                     ...
                                     <div class="col-md-6">
                                        <label for="student_standard">Nama Kelas & Standar <span class="red">*</span></label>
                                        <select class="form-control select2" name="student_standard" id="student_standard" style="width: 100%;">
                                            <?php foreach($school_standard as $standard){
                                                ?>
                                                <option value="<?php echo $standard->standard_id; ?>" <?php if(isset($_REQUEST["student_standard"]) && $_REQUEST["student_standard"]==$standard->standard_id){echo "selected"; } ?>>
                                                    <?php 
                                                    $q = $this->users_model->get_user_by_id($standard->school_id);
                                                    echo $q->user_class_name;
                                                    echo " - ";
