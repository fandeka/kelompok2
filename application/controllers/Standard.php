    ...
    public function manage_standard(){
        if(_is_user_login($this)){
            ...
            if($_POST){
                ...
                {
                     $q = $this->db->query("select * from standard where school_id="._get_current_user_id($this)." AND standard_title='".$this->input->post('standard_title')."'"." AND year='".$this->input->post('year')."'");
